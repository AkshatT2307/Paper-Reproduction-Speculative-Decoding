...
for sample in tqdm(xsum):
    ...
    original_summary.append(tokenizer.decode(target_ids[0][n:], skip_special_tokens=True))
    speculative_summary.append(tokenizer.decode(speculative_ids[0][n:], skip_special_tokens=True))
...
results = []
results.append({
    "prompt": xsum['document'],
    "reference": xsum['summary'],
    "speculative_summary": speculative_summary,
    "original_summary": original_summary,
    "acceptance_ratio": acceptance_rate,
    "inference_speed": target_speed,
    "speculative_speed": speculative_speed
